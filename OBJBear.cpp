...
OBJBear::OBJBear() {
    ...
    fp = fopen("/Users/JJK/Desktop/167hw3/CSE167_3/CSE167_3/bear.obj", "r");
    ...
    fclose(fp);
    printf("INITIAL OBJCYC WHATFOSEJFW I HATE THEISvert %lu norm %lu indi %lu\n", vertices.size(), normals.size(),indices.size());
...
OBJBear::OBJBear(const OBJBear &obj){
    updateOn = true;
    indices = obj.indices;
...
void OBJBear::parse(const char *filepath)
{
